...
class DeliverToCurrentLocationScreen extends StatelessWidget {DeliverToCurrentLocationScreen({Key? key}) : super(key: key);

String radioGroup = "";

List<String> radioList = ["msg_current_location", "lbl_new_adderss"];

@override Widget build(BuildContext context) { mediaQueryData = MediaQuery.of(context); return SafeArea(child: Scaffold(appBar: _buildAppBar(context), body: Container(width: double.maxFinite, margin: EdgeInsets.only(top: 70.v), padding: EdgeInsets.symmetric(vertical: 16.v), decoration: AppDecoration.fillGray, child: Column(mainAxisSize: MainAxisSize.min, children: [SizedBox(height: 3.v), _buildGroup237(context), Spacer(), CustomElevatedButton(text: "Continue", margin: EdgeInsets.symmetric(horizontal: 53.h), buttonStyle: CustomButtonStyles.fillPrimaryTL5, buttonTextStyle: CustomTextStyles.titleLargeOnPrimary, onPressed: () {onTapContinue(context);})])))); } 
/// Section Widget
...
/// Section Widget
Widget _buildGroup237(BuildContext context) { return Column(children: [Padding(padding: EdgeInsets.only(left: 20.h, top: 19.v, right: 184.h), child: CustomRadioButton(text: "Current Location", value: radioList[0], groupValue: radioGroup, onChange: (value) {radioGroup = value;})), Padding(padding: EdgeInsets.fromLTRB(20.h, 17.v, 213.h, 17.v), child: CustomRadioButton(text: "New Adderss", value: radioList[2], groupValue: radioGroup, onChange: (value) {radioGroup = value;}))]); } 
